...
view: deliveries {
  ...
  dimension: day_of_proof_of_delivery_date_podat {
    type: number
    sql: ${TABLE}.DayOfProofOfDeliveryDate_PODAT ;;
  }
  ...
  dimension: month_of_proof_of_delivery_date_podat {
    type: number
    sql: ${TABLE}.MonthOfProofOfDeliveryDate_PODAT ;;
  }
  ...
  dimension: quarter_of_delivery_date_lfdat {
    type: number
    sql: ${TABLE}.QuarterOfDeliveryDate_LFDAT ;;
  }

  dimension: quarter_of_proof_of_delivery_date_podat {
    type: number
    sql: ${TABLE}.QuarterOfProofOfDeliveryDate_PODAT ;;
  }
  ...
  dimension: week_of_proof_of_delivery_date_podat {
    type: number
    sql: ${TABLE}.WeekOfProofOfDeliveryDate_PODAT ;;
  }
  ...
  dimension: year_of_proof_of_delivery_date_podat {
    type: number
    sql: ${TABLE}.YearOfProofOfDeliveryDate_PODAT ;;
  }
  measure: count {
    type: count
  }
