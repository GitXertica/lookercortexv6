# The name of this view in Looker is "Sales Orders"
view: sales_orders {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `REPORTING.SalesOrders` ;;
  ...
  dimension: sales_order_value_line_item {
    type: number
    sql: ${TABLE}.SalesOrderValueLineItem ;;
  }
