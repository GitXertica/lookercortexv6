# The name of this view in Looker is "Purchase Documents Flow"
view: purchase_documents_flow {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `REPORTING.PurchaseDocuments_Flow` ;;
  ...
  dimension: account_assignment_zekkn {
    type: string
    sql: ${TABLE}.AccountAssignment_ZEKKN ;;
  }
  ...
  dimension: gl_account_sakto {
    type: string
    sql: ${TABLE}.GlAccount_SAKTO ;;
  }
  ...
  dimension: goodsrecipient_wempf {
    type: string
    sql: ${TABLE}.Goodsrecipient_WEMPF ;;
  }

  dimension: gr_amount_usd_wrbtr {
    type: number
    sql: ${TABLE}.GrAmountUSD_WRBTR ;;
  }

  dimension: gr_amount_wrbtr {
    type: number
    sql: ${TABLE}.GrAmount_WRBTR ;;
  }

  dimension: gr_balance_amount_netwr_wrbtr {
    type: number
    sql: ${TABLE}.GrBalanceAmount_NETWR_WRBTR ;;
  }

  dimension: gr_balance_amount_usd_netwr_wrbtr {
    type: number
    sql: ${TABLE}.GrBalanceAmountUSD_NETWR_WRBTR ;;
  }

  dimension: gr_balance_quantity_menge {
    type: number
    sql: ${TABLE}.GrBalanceQuantity_MENGE ;;
  }

  dimension: gr_quantity_menge {
    type: number
    sql: ${TABLE}.GrQuantity_MENGE ;;
  }
  ...
  dimension: grossordervaluein_pocurrency_usd_brtwr {
    type: number
  ...
  dimension: internal_key_imkey {
    type: string
    sql: ${TABLE}.InternalKey_IMKEY ;;
  }
  ...
  dimension: internalcounter_aplzl {
    type: string
    sql: ${TABLE}.Internalcounter_APLZL ;;
  }
  ...
  dimension: ir_amount_refwr {
    type: number
    sql: ${TABLE}.IrAmount_REFWR ;;
  }

  dimension: ir_amount_usd_refwr {
    type: number
    sql: ${TABLE}.IrAmountUSD_REFWR ;;
  }

  dimension: ir_balance_amount_netwr_refwr {
    type: number
    sql: ${TABLE}.IrBalanceAmount_NETWR_REFWR ;;
  }

  dimension: ir_balance_amount_usd_netwr_refwr {
    type: number
    sql: ${TABLE}.IrBalanceAmountUSD_NETWR_REFWR ;;
  }

  dimension: ir_balance_quantity_menge {
    type: number
    sql: ${TABLE}.IrBalanceQuantity_MENGE ;;
  }

  dimension: ir_quantity_menge {
    type: number
    sql: ${TABLE}.IrQuantity_MENGE ;;
  }
  ...
  dimension: item_categoryin_purchasing_document_desc_pstyp {
    type: string
    sql: ${TABLE}.ItemCategoryinPurchasingDocumentDesc_PSTYP ;;
  }
  ...
  dimension: latest_gr_document_belnr {
    type: string
    sql: ${TABLE}.LatestGrDocument_BELNR ;;
  }

  dimension_group: latest_gr_document_date_budat {
    type: time
    timeframes: [raw, date, week, month, quarter, year]
    convert_tz: no
    datatype: date
    sql: ${TABLE}.LatestGrDocumentDate_BUDAT ;;
  }

  dimension: latest_ir_document_belnr {
    type: string
    sql: ${TABLE}.LatestIrDocument_BELNR ;;
  }

  dimension_group: latest_ir_document_date_budat {
    type: time
    timeframes: [raw, date, week, month, quarter, year]
    convert_tz: no
    datatype: date
    sql: ${TABLE}.LatestIrDocumentDate_BUDAT ;;
  }
  ...
  dimension: network_number_nplnr {
    type: string
    sql: ${TABLE}.NetworkNumber_NPLNR ;;
  }
  ...
  dimension: partneraccount_vptnr {
    type: string
    sql: ${TABLE}.Partneraccount_VPTNR ;;
  }
  ...
  dimension: purchasing_document_category_desc_bstyp {
    type: string
    sql: ${TABLE}.PurchasingDocumentCategoryDesc_BSTYP ;;
  }
  ...
  dimension: release_status_desc_frgzu {
    type: string
    sql: ${TABLE}.ReleaseStatusDesc_FRGZU ;;
  }
  ...
  dimension: routingnumber_aufpl {
    type: string
    sql: ${TABLE}.Routingnumber_AUFPL ;;
  }

  dimension: sales_document_item_vbelp_vbelp {
    type: string
    sql: ${TABLE}.SalesDocumentItem_VBELP_VBELP ;;
  }

  dimension: sales_document_number_vbeln_vbeln {
    type: string
    sql: ${TABLE}.SalesDocumentNumber_VBELN_VBELN ;;
  }
  ...
  dimension: status_desc_statu {
    type: string
    sql: ${TABLE}.StatusDesc_STATU ;;
  }
  ...
  dimension: wbs_ps_psp_pnr {
    type: string
    sql: ${TABLE}.WBS_PS_PSP_PNR ;;
  }
